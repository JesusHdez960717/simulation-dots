...
public class IA extends Agent {
    ...
    public Image getImage() {
        switch (getLastAction()) {
            case Player.N:
                return new ImageIcon("media/icons/iau" + getTeam() + ".png").getImage();
            case Player.W:
                return new ImageIcon("media/icons/ial" + getTeam() + ".png").getImage();
            case Player.S:
                return new ImageIcon("media/icons/iad" + getTeam() + ".png").getImage();
            case Player.E:
                return new ImageIcon("media/icons/iar" + getTeam() + ".png").getImage();
            case Player.NOTHING:
                return new ImageIcon("media/icons/iad" + getTeam() + ".png").getImage();
        }
